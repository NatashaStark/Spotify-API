...
namespace PruebaAcidLabs.Controllers
{
    public class ArtistaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nombre,Popularidad")] Artista artista)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nombre,Popularidad")] Artista artista)
        {
            if (ModelState.IsValid)
            {
